...
describe('Users tests', () => {
    ...
    test('Should respond correctly if no correct user id provided', async () => {
        await request(app)
            .put('/users/updateUsersById/unId')
            .send({
                "id": 0,
                "name": "Test user updated",
                "email": "testuserupdated@gmail.com",
    ...
    test('Should delete a user by id', async () => {
        await request(app)
            .delete('/users/deleteUsersById/0')
            .send()
            .expect(200);
    });
    ...
    test('Should respond correctly if no correct user id provided', async () => {
        await request(app)
            .delete('/users/deleteUsersById/otroId')
            .send()
            .expect(400);
    });
